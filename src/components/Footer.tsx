...
export const Footer: React.FC<FooterProps> = ({ onScrollToTop, onNavigate }) => {
  ...
  return (
    <footer className="border-t border-white/10 bg-[#141313] relative z-10 pt-16 pb-12 w-full max-w-full overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-12 lg:px-16 space-y-12">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          ...
          {/* Quick Sub-Links */}
          <div className="flex flex-wrap items-center gap-4 sm:gap-8 text-xs font-semibold uppercase tracking-wider text-[#c8c5cb]/70">
            <button
            ...
            <button
              ...
              className="w-9 h-9 rounded-full bg-white/5 hover:bg-white/15 border border-white/10 flex items-center justify-center text-white transition-all hover:scale-110 active:scale-95 cursor-pointer"
              title="Scroll to top"
            >
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-[#c8c5cb]/50">
          <p>© 2026 P. Ramanan • Building Intelligence</p>
          <div className="flex items-center gap-2">
