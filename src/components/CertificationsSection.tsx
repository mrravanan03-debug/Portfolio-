...
export const CertificationsSection: React.FC<CertificationsSectionProps> = ({ onSelectCert }) => {
  ...
  return (
    <section id="certifications" className="py-20 sm:py-24 md:py-32 max-w-7xl mx-auto px-4 sm:px-8 md:px-12 lg:px-16 relative w-full max-w-full overflow-hidden">
      ...
      >
        <div>
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight text-[#e5e2e1] uppercase flex items-center gap-4 break-words">
            <KineticHeadline
