  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative w-full max-w-2xl bg-[#141313] border border-white/20 rounded-2xl shadow-[0_25px_70px_rgba(0,0,0,0.9)] overflow-hidden flex flex-col my-auto"
      >
